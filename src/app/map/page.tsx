...
export const metadata: Metadata = {
  title: "Карта храмов Москвы — найти храм рядом, маршрут, метро и МЦД",
  description:
    "Интерактивная карта православных храмов Москвы: поиск храма рядом, адреса, ближайшее метро и МЦД, маршруты, официальные сайты, фото и контакты.",
  keywords: ["карта храмов Москвы", "поиск храмов Москвы на карте", "храм рядом", "церковь рядом", "храмы рядом с метро", "храмы рядом с МЦД", "православные храмы Москвы"],
  alternates: { canonical: "/map" },
  openGraph: {
    title: "Карта храмов Москвы — найти храм рядом | HramGo",
    description: "Найдите православный храм Москвы на карте, посмотрите адрес, ближайшее метро или МЦД, маршрут, контакты и официальный сайт.",
  ...
  twitter: {
    ...
    title: "Карта храмов Москвы — найти храм рядом | HramGo",
    description: "Храмы Москвы на карте: адреса, метро, МЦД, маршруты, фото и контакты.",
