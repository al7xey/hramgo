...
export const metadata: Metadata = {
  title: "Храмы Москвы — каталог, поиск по адресу, метро, МЦД и расписанию",
  description:
    "Каталог православных храмов Москвы: поиск по названию, улице, району, адресу, метро, МЦД, расписанию богослужений, фото, контактам и официальным сайтам.",
  keywords: [
    "храмы Москвы",
  ...
  openGraph: {
    title: "Храмы Москвы — каталог, адреса, расписания, метро и МЦД | HramGo",
    description: "Поиск православных храмов Москвы по названию, улице, району, метро и МЦД: адреса, расписания богослужений, контакты и фото.",
  ...
  twitter: {
    ...
    title: "Храмы Москвы — каталог, адреса, расписания, метро и МЦД | HramGo",
    description: "Каталог храмов Москвы с поиском по улице, району, метро, МЦД, расписанию, фото и контактам.",
